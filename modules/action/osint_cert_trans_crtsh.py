...
class osint_cert_trans_crtsh(actionModule):
    def __init__(self, config, display, lock):
        super(osint_cert_trans_crtsh, self).__init__(config, display, lock)
        self.title = "Certificate Tansparency - Crt.sh"
        self.shortName = "CertTransCrtsh"
        self.description = ""
