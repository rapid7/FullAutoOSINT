...
class osint_cert_trans_censys(actionModule):
    def __init__(self, config, display, lock):
        super(osint_cert_trans_censys, self).__init__(config, display, lock)
        self.title = "Certificate Tansparency - Censys"
        self.shortName = "CertTransCensys"
        self.description = ""
